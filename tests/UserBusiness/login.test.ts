...
describe("login", () => {
    ...
    test("retorna um erro caso 'email' não seja uma string", async () => {
        expect.assertions(2)
    ...
    test("retorna um erro caso 'password' não seja uma string", async () => {
        expect.assertions(2)
    ...
    test("retorna um erro caso 'email' não seja cadastrado", async () => {
        expect.assertions(2)
    ...
    test("retorna um erro caso 'password' esteja incorreto", async () => {
        expect.assertions(2)
